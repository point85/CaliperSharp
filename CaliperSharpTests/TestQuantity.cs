...
namespace CaliperSharpTests
{
	...
	public class TestQuantity : BaseTest
	{
		...
		public void TestNamedQuantity()
		{
			...
			Assert.IsTrue(IsCloseTo(f.GetAmount(), eNA.GetAmount(), DELTA6));
			Assert.IsTrue(IsCloseTo(f.GetAmount(), 96485.3328959, DELTA5));
			...
			Assert.IsTrue(IsCloseTo(eps0.GetAmount(), 8.854187817E-12, DELTA6));
			Assert.IsTrue(IsCloseTo(eps0.Convert(fm).GetAmount(), 8.854187817E-12, DELTA6));
		...
		public void TestTime()
		{
			...
			Assert.IsTrue(IsCloseTo(Converted.GetAmount(), bd60, DELTA6));
			Assert.IsTrue(Converted.GetUOM().Equals(second));

			Quantity sixty = oneMin.Divide(oneSec);
			Assert.IsTrue(IsCloseTo(sixty.GetAmount(), 1, DELTA6));
			Assert.IsTrue(IsCloseTo(sixty.GetUOM().GetScalingFactor(), bd60, DELTA6));

			Quantity q1 = sixty.Convert(sys.GetOne());
			Assert.IsTrue(q1.GetUOM().Equals(sys.GetOne()));
			Assert.IsTrue(IsCloseTo(q1.GetAmount(), bd60, DELTA6));

			q1 = q1.Multiply(oneSec);
			Assert.IsTrue(q1.Convert(second).GetUOM().Equals(second));
			Assert.IsTrue(IsCloseTo(q1.GetAmount(), bd60, DELTA6));

			q1 = q1.Convert(minute);
			Assert.IsTrue(q1.GetUOM().Equals(minute));
			Assert.IsTrue(IsCloseTo(q1.GetAmount(), 1, DELTA6));
		...
		public void TestTemperature()
		{
			...
			Assert.IsTrue(IsCloseTo(q2.GetAmount(), oneHundred, DELTA6));
			Assert.IsTrue(IsCloseTo(q2.Convert(F).GetAmount(), bd212, DELTA6));

			double bd32 = 32;
			q1 = new Quantity(bd32, F);
			q2 = q1.Convert(C);
			Assert.IsTrue(IsCloseTo(q2.GetAmount(), 0, DELTA6));
			Assert.IsTrue(IsCloseTo(q2.Convert(F).GetAmount(), bd32, DELTA6));

			q1 = new Quantity(0, F);
			q2 = q1.Convert(C);
			Assert.IsTrue(IsCloseTo(q2.GetAmount(), -17.7777777777778, DELTA6));
			Assert.IsTrue(IsCloseTo(q2.Convert(F).GetAmount(), 0, DELTA6));

			double bd459 = 459.67;
			q1 = new Quantity(bd459, R);
			q2 = q1.Convert(F);
			Assert.IsTrue(IsCloseTo(q2.GetAmount(), 0, DELTA6));
			Assert.IsTrue(IsCloseTo(q2.Convert(R).GetAmount(), bd459, DELTA6));

			double bd255 = 255.3722222222222;
			q2 = q1.Convert(K);
			Assert.IsTrue(IsCloseTo(q2.GetAmount(), bd255, DELTA6));
			Assert.IsTrue(IsCloseTo(q2.Convert(R).GetAmount(), bd459, DELTA6));

			double bd17 = -17.7777777777778;
			q2 = q1.Convert(C);
			Assert.IsTrue(IsCloseTo(q2.GetAmount(), bd17, DELTA6));
			Assert.IsTrue(IsCloseTo(q2.Convert(R).GetAmount(), bd459, DELTA6));
			...
			q2 = q1.Convert(C);
			Assert.IsTrue(IsCloseTo(q2.GetAmount(), 0, DELTA6));
			Assert.IsTrue(IsCloseTo(q2.Convert(K).GetAmount(), bd273, DELTA6));

			q1 = new Quantity(0, K);
			q2 = q1.Convert(R);
			Assert.IsTrue(IsCloseTo(q2.GetAmount(), 0, DELTA6));
			Assert.IsTrue(IsCloseTo(q2.Convert(K).GetAmount(), 0, DELTA6));
		}
		...
		public void TestLength()
		{
			...
			Assert.IsTrue(IsCloseTo(q2.GetAmount(), 144, DELTA6));
			Assert.IsTrue(IsCloseTo(q2.Convert(ft2).GetAmount(), 1, DELTA6));

			q1 = new Quantity(1, sys.GetUOM(Unit.SQUARE_METRE));
			q2 = q1.Convert(ft2);
			Assert.IsTrue(IsCloseTo(q2.GetAmount(), 10.76391041670972, DELTA6));
			Assert.IsTrue(IsCloseTo(q2.Convert(m2).GetAmount(), 1, DELTA6));

			double bd = 3;
			q1 = new Quantity(bd, ft);
			q2 = q1.Convert(yd);
			Assert.IsTrue(IsCloseTo(q2.GetAmount(), 1, DELTA6));
			Assert.IsTrue(IsCloseTo(q2.Convert(ft).GetAmount(), bd, DELTA6));

			bd = 0.3048;
			q1 = new Quantity(1, ft);
			q2 = q1.Convert(m);
			Assert.IsTrue(IsCloseTo(q2.GetAmount(), bd, DELTA6));
			Assert.IsTrue(IsCloseTo(q2.Convert(ft).GetAmount(), 1, DELTA6));

			bd = oneHundred;
			q1 = new Quantity(bd, cm);
			q2 = q1.Convert(m);
			Assert.IsTrue(IsCloseTo(q2.GetAmount(), 1, DELTA6));
			Assert.IsTrue(IsCloseTo(q2.Convert(cm).GetAmount(), bd, DELTA6));
			...
			Assert.IsTrue(IsCloseTo(q3.GetAmount(), bd + bd, DELTA6));
			Assert.IsTrue(IsCloseTo(q3.Convert(m).GetAmount(), 1, DELTA6));

			Quantity q4 = q2.Add(q1);
			Assert.IsTrue(IsCloseTo(q4.GetAmount(), bd + bd, DELTA6));
			Assert.IsTrue(IsCloseTo(q4.Convert(m).GetAmount(), 1, DELTA6));
			Assert.IsTrue(q3.Equals(q4));

			// Subtract
			q3 = q1.Subtract(q2);
			Assert.IsTrue(IsCloseTo(q3.GetAmount(), 0, DELTA6));
			Assert.IsTrue(IsCloseTo(q3.Convert(m).GetAmount(), 0, DELTA6));

			q4 = q2.Subtract(q1);
			Assert.IsTrue(IsCloseTo(q4.GetAmount(), 0, DELTA6));
			Assert.IsTrue(IsCloseTo(q4.Convert(m).GetAmount(), 0, DELTA6));
			Assert.IsTrue(q3.Equals(q4));

			// Multiply
			q3 = q1.Multiply(q2);
			Assert.IsTrue(IsCloseTo(q3.GetAmount(), 2500, DELTA6));

			q4 = q3.Convert(cm2);
			Assert.IsTrue(IsCloseTo(q4.GetAmount(), 2500, DELTA6));

			q4 = q3.Convert(m2);
			Assert.IsTrue(IsCloseTo(q4.GetAmount(), 0.25, DELTA6));
		...
		public void TestUSQuantity()
		{
			...
			Assert.IsTrue(IsCloseTo(q2.GetAmount(), 2310, DELTA6));
			Assert.IsTrue(q2.GetUOM().Equals(in3));

			q1 = new Quantity(128, floz);
			q2 = q1.Convert(qt);
			Assert.IsTrue(IsCloseTo(q2.GetAmount(), 4, DELTA6));
			Assert.IsTrue(q2.GetUOM().Equals(qt));
			...
			Assert.IsTrue(IsCloseTo(q2.GetAmount(), 0.6, DELTA3));

			// US ton to British ton
			q1 = new Quantity(10, sys.GetUOM(Unit.US_TON));
			q2 = q1.Convert(sys.GetUOM(Unit.BR_TON));
			Assert.IsTrue(IsCloseTo(q2.GetAmount(), 8.928571428, DELTA6));

			// troy ounce to ounce
			q1 = new Quantity(10, Unit.TROY_OUNCE);
			Assert.IsTrue(IsCloseTo(q1.Convert(Unit.OUNCE).GetAmount(), 10.971, DELTA3));

			// deci-litre to quart
			q1 = new Quantity(10, Prefix.DECI, Unit.LITRE);
			q2 = q1.Convert(Unit.US_QUART);
			Assert.IsTrue(IsCloseTo(q2.GetAmount(), 1.0566882, DELTA6));
		}
		...
		public void TestSIQuantity()
		{
			...
			Assert.IsTrue(IsCloseTo(q2.GetAmount(), 0.01, DELTA6));
			Assert.IsTrue(q2.GetUOM().Equals(m3));

			q2 = q1.Convert(litre);
			Assert.IsTrue(IsCloseTo(q2.GetAmount(), ten, DELTA6));
			Assert.IsTrue(q2.GetUOM().Equals(litre));
			...
			Assert.IsTrue(IsCloseTo(q3.GetUOM().GetScalingFactor(), 1, DELTA6));
			Assert.IsTrue(q3.GetUOM().GetAbscissaUnit().Equals(m));
			Assert.IsTrue(IsCloseTo(q3.GetUOM().GetOffset(), 0, DELTA6));
			Assert.IsTrue(IsCloseTo(q3.GetAmount(), 2.02, DELTA6));

			Quantity q4 = q3.Convert(cm);
			Assert.IsTrue(IsCloseTo(q4.GetAmount(), 202, DELTA6));
			Assert.IsTrue(q4.GetUOM().Equals(cm));

			// Subtract
			q3 = q3.Subtract(q1);
			Assert.IsTrue(IsCloseTo(q3.GetUOM().GetScalingFactor(), 1, DELTA6));
			Assert.IsTrue(q3.GetUOM().GetAbscissaUnit().Equals(m));
			Assert.IsTrue(IsCloseTo(q3.GetAmount(), 0.02, DELTA6));

			q4 = q3.Convert(cm);
			Assert.IsTrue(IsCloseTo(q4.GetAmount(), 2, DELTA6));
			Assert.IsTrue(q4.GetUOM().Equals(cm));

			// Multiply
			q3 = q1.Multiply(q2);
			Assert.IsTrue(IsCloseTo(q3.GetAmount(), 4, DELTA6));
			...
			Assert.IsTrue(q4.GetUOM().Equals(sys.GetOne()));

			q4 = q3.Divide(q1);
			Assert.IsTrue(q4.Equals(q2));

			q4 = q3.Convert(m2);
			Assert.IsTrue(IsCloseTo(q4.GetAmount(), 0.04, DELTA6));
			Assert.IsTrue(q4.GetUOM().Equals(m2));

			// Divide
			q3 = q3.Divide(q2);
			Assert.IsTrue(IsCloseTo(q3.GetAmount(), 2.0, DELTA6));
			Assert.IsTrue(q3.GetUOM().Equals(m));
			...
			Assert.IsTrue(IsCloseTo(q1.GetAmount(), 20, DELTA6));

			// Invert
			q1 = new Quantity(10, mps);
			q2 = q1.Invert();
			Assert.IsTrue(IsCloseTo(q2.GetAmount(), 0.1, DELTA6));
			Assert.IsTrue(q2.GetUOM().Equals(secPerM));

			q2 = q2.Invert();
			Assert.IsTrue(IsCloseTo(q2.GetAmount(), 10, DELTA6));
			Assert.IsTrue(q2.GetUOM().Equals(mps));
			...
			Assert.IsTrue(IsCloseTo(q2.GetAmount(), 10, DELTA6));
			Assert.IsTrue(q2.GetUOM().Equals(oneOverM));
			...
			Assert.IsTrue(q3.GetUOM().Equals(sys.GetUOM(Unit.NEWTON)));
			...
			Assert.IsTrue(q4.GetUOM().Equals(sys.GetUOM(Unit.JOULE)));
			...
			q3 = q1.Multiply(q2);
			Assert.IsTrue(IsCloseTo(q3.GetAmount(), 10, DELTA6));
			Assert.IsTrue(q3.GetUOM().Equals(sys.GetUOM(Unit.FARAD)));
			...
			q3 = q1.Multiply(q2);
			Assert.IsTrue(IsCloseTo(q3.GetAmount(), 10, DELTA6));
			Assert.IsTrue(q3.GetUOM().Equals(sys.GetUOM(Unit.AMPERE)));
			...
			Assert.IsTrue(IsCloseTo(qR.GetUOM().GetScalingFactor(), gas.GetUOM().GetScalingFactor(), DELTA6));

			// Sieverts
			q1 = new Quantity(20, sys.GetUOM(Prefix.MILLI, Unit.SIEVERTS_PER_HOUR));
			q2 = new Quantity(24, sys.GetHour());
			q3 = q1.Multiply(q2);
			Assert.IsTrue(IsCloseTo(q3.GetAmount(), 480, DELTA6));
		...
		public void TestPowers()
		{
			...
			Assert.IsTrue(IsCloseTo(q4.GetAmount(), 1, DELTA6));
			Assert.IsTrue(q4.GetUOM().GetBaseUOM().Equals(m2));

			Quantity q2 = q1.Convert(p2);
			Assert.IsTrue(IsCloseTo(q2.GetAmount(), amount, DELTA6));
			Assert.IsTrue(q2.GetUOM().GetBaseUOM().Equals(m2));
			...
			q3 = q1.Power(2);
			Assert.IsTrue(IsCloseTo(q3.GetAmount(), 100, DELTA6));
			Assert.IsTrue(q3.GetUOM().GetBaseSymbol().Equals(ft2.GetBaseSymbol()));

			q4 = q3.Convert(sys.GetUOM(Unit.SQUARE_METRE));
			Assert.IsTrue(IsCloseTo(q4.GetAmount(), 9.290304, DELTA6));

			q3 = q1.Power(1);
			Assert.IsTrue(q3.GetAmount().Equals(q1.GetAmount()));
			Assert.IsTrue(q3.GetUOM().GetBaseSymbol().Equals(q1.GetUOM().GetBaseSymbol()));

			q3 = q1.Power(0);
			Assert.IsTrue(q3.GetAmount().Equals(1));
			Assert.IsTrue(q3.GetUOM().GetBaseSymbol().Equals(sys.GetOne().GetBaseSymbol()));

			q3 = q1.Power(-1);
			Assert.IsTrue(q3.GetAmount().Equals(0.1));
			Assert.IsTrue(q3.GetUOM().Equals(ft.Invert()));

			q3 = q1.Power(-2);
			Assert.IsTrue(q3.GetAmount().Equals(0.01));
			Assert.IsTrue(q3.GetUOM().Equals(ft2.Invert()));
		}
		...
		public void TestSIUnits()
		{
			...
			Assert.IsTrue(IsCloseTo(q3.GetAmount(), oneHundred, DELTA6));
			Assert.IsTrue(q3.GetUOM().GetBaseSymbol().Equals(nm.GetBaseSymbol()));
			Assert.IsTrue(IsCloseTo(q3.GetUOM().GetScalingFactor(), 1, DELTA6));
			Assert.IsTrue(IsCloseTo(q3.GetUOM().GetOffset(), 0, DELTA6));

			q3 = q3.Convert(joule);
			Assert.IsTrue(IsCloseTo(q3.GetAmount(), oneHundred, DELTA6));
			Assert.IsTrue(q3.GetUOM().Equals(joule));
			Assert.IsTrue(IsCloseTo(q3.GetUOM().GetScalingFactor(), 1, DELTA6));

			q3 = q3.Convert(nm);
			Assert.IsTrue(IsCloseTo(q3.GetAmount(), oneHundred, DELTA6));
			Assert.IsTrue(q3.GetUOM().Equals(nm));
			Assert.IsTrue(IsCloseTo(q3.GetUOM().GetScalingFactor(), 1, DELTA6));
			...
			q2 = q1.Convert(metre);
			Assert.IsTrue(IsCloseTo(q2.GetAmount(), 1, DELTA6));
			Assert.IsTrue(q2.GetUOM().GetEnumeration().Equals(Unit.METRE));
			Assert.IsTrue(IsCloseTo(q2.GetUOM().GetScalingFactor(), 1, DELTA6));

			q2 = q2.Convert(cm);
			Assert.IsTrue(IsCloseTo(q2.GetAmount(), oneHundred, DELTA6));
			Assert.IsTrue(IsCloseTo(q2.GetUOM().GetScalingFactor(), 0.01, DELTA6));

			q2 = q1;
			q3 = q1.Multiply(q2);
			Assert.IsTrue(IsCloseTo(q3.GetAmount(), 10000, DELTA6));
			Assert.IsTrue(IsCloseTo(q3.GetUOM().GetScalingFactor(), 0.0001, DELTA6));
			Assert.IsTrue(IsCloseTo(q3.GetUOM().GetOffset(), 0, DELTA6));
			...
			q3 = q3.Convert(m2);
			Assert.IsTrue(IsCloseTo(q3.GetAmount(), 1, DELTA6));
			Assert.IsTrue(q3.GetUOM().Equals(m2));
			Assert.IsTrue(IsCloseTo(q3.GetUOM().GetScalingFactor(), 1, DELTA6));

			q3 = q3.Convert(cm2);
			Assert.IsTrue(IsCloseTo(q3.GetAmount(), bd1, DELTA6));
			Assert.IsTrue(q3.GetUOM().Equals(cm2));
			Assert.IsTrue(IsCloseTo(q3.GetUOM().GetScalingFactor(), 1, DELTA6));
			...
			Assert.IsTrue(IsCloseTo(qft3.GetAmount(), 35.31466672148859, DELTA6));

			Quantity qtym3 = qft3.Convert(m3);
			Assert.IsTrue(IsCloseTo(qtym3.GetAmount(), 1, DELTA6));

			Quantity qm3 = megcm3.Convert(m3);
			Assert.IsTrue(IsCloseTo(qm3.GetAmount(), 1, DELTA6));
			qm3 = qm3.Convert(cm3);
			Assert.IsTrue(IsCloseTo(qm3.GetAmount(), 1E+06, DELTA6));

			Quantity qcm3 = onem3.Convert(cm3);
			Assert.IsTrue(IsCloseTo(qcm3.GetAmount(), 1E+06, DELTA6));
			...
			UnitOfMeasure uom = sys.CreateQuotientUOM(UnitType.UNCLASSIFIED, "1/F", "1/F", "one over farad", sys.GetOne(),
					farad);
			Assert.IsTrue(uom.GetSymbol().Equals("1/F"));
			...
			Assert.IsTrue(IsCloseTo(q2.GetAmount(), twentyPi, DELTA6));
			...
			q2 = q1.Convert(sys.GetUOM(Unit.RAD_PER_SEC));
			Assert.IsTrue(IsCloseTo(q2.GetAmount(), 1.04719755119, DELTA6));
			...
			Assert.IsTrue(IsCloseTo(q3.GetAmount(), 600, DELTA6));

			q1 = new Quantity(1, sys.GetUOM(Unit.ELECTRON_VOLT));
			q2 = q1.Convert(sys.GetUOM(Unit.JOULE));
			Assert.IsTrue(IsCloseTo(q2.GetAmount(), 1.60217656535E-19, DELTA6));
		...
		public void TestEquations()
		{
			...
			Assert.IsTrue(IsCloseTo(bmi.GetAmount(), 25, DELTA6));
			...
			Assert.IsTrue(IsCloseTo(e.GetAmount(),
			...
			Assert.IsTrue(IsCloseTo(n.GetAmount(), 28.018673, DELTA6));
			...
			Assert.IsTrue(IsCloseTo(ev.GetAmount(), 1.65, DELTA2));
			...
			Assert.IsTrue(IsCloseTo(wavelength.GetAmount(), 749.48, DELTA2));
			...
			Assert.IsTrue(IsCloseTo(f.GetAmount(), 2.20462, DELTA5));
			...
			Assert.IsTrue(IsCloseTo(concentration.GetAmount(), 1000, DELTA6));

			Quantity katals = concentration.Multiply(new Quantity(1, Unit.LITRE)).Convert(Unit.KATAL);
			Assert.IsTrue(IsCloseTo(katals.GetAmount(), 0.01666667, DELTA6));
			...
			Assert.IsTrue(IsCloseTo(intensity.GetAmount(), 56703.67, DELTA2));
			...
			Assert.IsTrue(IsCloseTo(velocity.GetAmount(), 719, DELTA3));
			...
			Assert.IsTrue(IsCloseTo(life150.GetAmount(), 33121.4, DELTA1));
		}
		...
		public void TestPackaging()
		{
			...
			Assert.IsTrue(IsCloseTo(q50.GetAmount(), 50, DELTA6));
			...
			Assert.IsTrue(IsCloseTo(q36.GetAmount(), 36, DELTA6));
			...
			Assert.IsTrue(IsCloseTo(q1.GetAmount(), 240, DELTA6));
			...
			Assert.IsTrue(IsCloseTo(q2.GetAmount(), 240, DELTA6));

			Quantity oneCan = new Quantity(one, one12ozCan);
			q2 = oneCan.Convert(sixPackCan);
			Assert.IsTrue(IsCloseTo(q2.GetAmount(), 0.1666666666666667, DELTA6));
			...
			Assert.IsTrue(IsCloseTo(draw.GetAmount(), 3.125, DELTA6));

			// case production
			Quantity packer = filler.Convert(caseph);
			Assert.IsTrue(IsCloseTo(packer.GetAmount(), 83.333333, DELTA6));
		}
		...
		public void TestGenericQuantity()
		{
			...
			Assert.IsTrue(IsCloseTo(q3.GetUOM().GetScalingFactor(), 1, DELTA6));
			Assert.IsTrue(q3.GetUOM().GetAbscissaUnit().Equals(a));
			Assert.IsTrue(IsCloseTo(q3.GetUOM().GetOffset(), 0, DELTA6));
			Assert.IsTrue(IsCloseTo(q3.GetAmount(), 44, DELTA6));
			...
			Assert.IsTrue(q3.GetUOM().GetAbscissaUnit().Equals(a));
			Assert.IsTrue(IsCloseTo(q3.GetUOM().GetOffset(), 0, DELTA6));
			Assert.IsTrue(IsCloseTo(q3.GetAmount(), -36, DELTA6));

			// Multiply
			q3 = q1.Multiply(q2);
			Assert.IsTrue(IsCloseTo(q3.GetAmount(), 16, DELTA6));
			Assert.IsTrue(IsCloseTo(q3.GetUOM().GetScalingFactor(), 1, DELTA6));
			Assert.IsTrue(IsCloseTo(q3.GetUOM().GetOffset(), 0, DELTA6));

			UnitOfMeasure a2 = sys.CreatePowerUOM(UnitType.UNCLASSIFIED, "a*2", "a*2", "A squared", a, 2);
			Quantity q4 = q3.Convert(a2);
			Assert.IsTrue(IsCloseTo(q4.GetAmount(), 160, DELTA6));
			Assert.IsTrue(q4.GetUOM().Equals(a2));

			q4 = q3.Divide(q2);
			Assert.IsTrue(q4.Equals(q1));
			Assert.IsTrue(IsCloseTo(q4.GetAmount(), 4, DELTA6));

			// Divide
			q3 = q1.Divide(q2);
			Assert.IsTrue(IsCloseTo(q3.GetAmount(), 1, DELTA6));
			Assert.IsTrue(IsCloseTo(q3.GetUOM().GetScalingFactor(), 0.1, DELTA6));
		...
		public void TestEquality()
		{
			...
			Assert.IsTrue(q4.GetUOM().GetBaseSymbol().Equals(sys.GetOne().GetSymbol()));
			Assert.IsTrue(q4.GetAmount().Equals(amount));

			// Newton-metre (Joules)
			q4 = q1.Multiply(q2);
			Assert.IsTrue(q5.GetUOM().GetBaseSymbol().Equals(q4.GetUOM().GetBaseSymbol()));
			Quantity q6 = q5.Convert(J);
			Assert.IsTrue(q6.GetAmount().Equals(q4.GetAmount()));

			// Newton
			q5 = q4.Divide(q2);
			Assert.IsTrue(q5.GetUOM().GetBaseSymbol().Equals(q1.GetUOM().GetBaseSymbol()));
			Assert.IsTrue(q5.Equals(q1));

			// metre
			q5 = q4.Divide(q1);
			Assert.IsTrue(q5.GetUOM().GetBaseSymbol().Equals(q2.GetUOM().GetBaseSymbol()));
			...
			// metre
			q4 = q5.Divide(q2);
			Assert.IsTrue(q4.GetUOM().GetBaseSymbol().Equals(q2.GetUOM().GetBaseSymbol()));
			Assert.IsTrue(q4.Equals(q2));
		...
		public void TestFinancial()
		{
			...
			Assert.IsTrue(IsCloseTo(q3.GetAmount(), 20, DELTA6));
		}
		...
		public void TestPowerProductConversions()
		{
			...
			Assert.IsTrue(IsCloseTo(lbfinQ.GetAmount(), 8.850745791327183, DELTA6));
			Quantity mpsQ = new Quantity(1, mps);

			Quantity fphQ = mpsQ.ConvertToPowerProduct(ft, hr);
			Assert.IsTrue(IsCloseTo(fphQ.GetAmount(), 11811.02362204724, DELTA6));

			Quantity mps2Q = fphQ.ConvertToPowerProduct(m, s);
			Assert.IsTrue(IsCloseTo(mps2Q.GetAmount(), 1, DELTA6));

			Quantity mps3Q = mpsQ.ConvertToPowerProduct(m, s);
			Assert.IsTrue(IsCloseTo(mps3Q.GetAmount(), 1, DELTA6));

			Quantity inlbfQ = nmQ.ConvertToPowerProduct(inch, lbf);
			Assert.IsTrue(IsCloseTo(inlbfQ.GetAmount(), 8.850745791327183, DELTA6));

			Quantity nm2Q = lbfinQ.ConvertToPowerProduct(n, m);
			Assert.IsTrue(IsCloseTo(nm2Q.GetAmount(), 1, DELTA6));
			...
			Assert.IsTrue(IsCloseTo(ft2Q.GetAmount(), 10.76391041670972, DELTA6));

			Quantity mmQ = ft2Q.ConvertToPowerProduct(m, m);
			Assert.IsTrue(IsCloseTo(mmQ.GetAmount(), 1, DELTA6));
			...
			Assert.IsTrue(IsCloseTo(ft3Q.GetAmount(), 35.31466672148858, DELTA6));

			Quantity m3Q2 = m3Q.ConvertToPowerProduct(m2, m);
			Assert.IsTrue(IsCloseTo(m3Q2.GetAmount(), 1, DELTA6));
			...
			Assert.IsTrue(IsCloseTo(perInQ.GetAmount(), 0.0254, DELTA6));
			...
			Assert.IsTrue(IsCloseTo(mphQ.GetAmount(), 0.6818181818181818, DELTA6));

			// test powers
			Quantity in2Q = m2Q.ConvertToPower(inch);
			Assert.IsTrue(IsCloseTo(in2Q.GetAmount(), 1550.003100006200, DELTA6));

			Quantity m2Q2 = in2Q.ConvertToPower(m);
			Assert.IsTrue(IsCloseTo(m2Q2.GetAmount(), 1, DELTA6));

			Quantity perInQ2 = perMQ.ConvertToPower(inch);
			Assert.IsTrue(IsCloseTo(perInQ2.GetAmount(), 0.0254, DELTA6));

			Quantity q1 = perInQ2.ConvertToPower(m);
			Assert.IsTrue(IsCloseTo(q1.GetAmount(), 1, DELTA6));

			Quantity inQ2 = mQ.ConvertToPower(inch);
			Assert.IsTrue(IsCloseTo(inQ2.GetAmount(), 39.37007874015748, DELTA6));
